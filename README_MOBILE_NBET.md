...
```
seatin-hita/nb_app_mobile
branch: main
```

### GIT REPO-config

```https://github.com/devbay225/game-profile/blob/main/nbet/release/config.json```
...
- IOS: Not support
- Android [APP](https://nbetapp.page.link/download)

## Firebase Dynamic Link
 - [Firebase dashboard](https://console.firebase.google.com/project/nbet-e8d94/durablelinks/links/https:~2F~2Fmu9casino.page.link)
